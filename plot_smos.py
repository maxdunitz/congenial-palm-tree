...
TLE = """1 36036U 09059A   19137.14905093  .00000031  00000-0  23800-4 0  9994
2 36036  98.4449 324.8709 0001269  88.2471 271.8863 14.39750387501197"""
...
hours = np.arange(0, 2*60, 0.1)

time = ts.utc(2019, 2, 7, hours)
...
if True:
    ...
    plt.ylabel('Geocenter radius (blue) or altitude (orange) (km)', fontsize=14)
    plt.show()
